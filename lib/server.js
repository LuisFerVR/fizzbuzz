...
app.get("/v1/explorers/stack/:stackRecibido", (request, response) => {
    const valorRecibido = request.params.stackRecibido;
    const res = ExplorerController.getExplorersUserNamesByStack(valorRecibido);
    response.json(res);
});